...
// migration logic.
//
// This package exposes a number of dialects that implement the Store interface. Most users will not
// need to implement their own Store, but if you need to support a database that is not supported,
