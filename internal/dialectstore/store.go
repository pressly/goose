...
type Store interface {
	...
	InsertVersion(ctx context.Context, tx sql.DBTxConn, tableName string, entity migration.Entity) error
	// InsertVersionNoTx inserts a version id into the version table without a transaction.
	InsertVersionNoTx(ctx context.Context, db sql.DBTxConn, tableName string, version migration.Entity) error

	// DeleteVersion deletes a version id from the version table within a transaction.
	DeleteVersion(ctx context.Context, tx sql.DBTxConn, tableName string, entity migration.Entity) error
	// DeleteVersionNoTx deletes a version id from the version table without a transaction.
	DeleteVersionNoTx(ctx context.Context, db sql.DBTxConn, tableName string, entity migration.Entity) error
	...
	GetLatestVersion(ctx context.Context, db sql.DBTxConn, tableName string) (migration.VersionID, error)
	...
	GetMigration(ctx context.Context, db sql.DBTxConn, tableName string, version migration.VersionID) (*GetMigrationResult, error)
	...
	ListMigrations(ctx context.Context, db sql.DBTxConn, tableName string) ([]*ListMigrationsResult, error)
}
...
func (s *store) CreateVersionTable(ctx context.Context, tx sql.DBTxConn, tableName string) error {
...
func (s *store) TableVersionExists(ctx context.Context, tx sql.DBTxConn, tableName string) (bool, error) {
	q := s.querier.TableExists(tableName)
	if q == "" {
...
func (s *store) InsertVersion(ctx context.Context, tx sql.DBTxConn, tableName string, entity migration.Entity) error {
...
func (s *store) InsertVersionNoTx(ctx context.Context, db sql.DBTxConn, tableName string, entity migration.Entity) error {
	q := s.querier.InsertVersion(tableName)
	_, err := db.ExecContext(ctx, q, entity.Version, true)
	return err
}

func (s *store) DeleteVersion(ctx context.Context, tx sql.DBTxConn, tableName string, entity migration.Entity) error {
...
func (s *store) DeleteVersionNoTx(ctx context.Context, db sql.DBTxConn, tableName string, entity migration.Entity) error {
	q := s.querier.DeleteVersion(tableName)
	_, err := db.ExecContext(ctx, q, entity.Version)
	return err
}

func (s *store) GetLatestVersion(ctx context.Context, db sql.DBTxConn, tableName string) (migration.VersionID, error) {
	q := s.querier.GetLatestVersion(tableName)
...
func (s *store) ListMigrations(ctx context.Context, db sql.DBTxConn, tableName string) ([]*ListMigrationsResult, error) {
